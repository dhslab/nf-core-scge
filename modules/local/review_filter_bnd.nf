...
// junctions (23 multi-cut INVERSION rows across 7 samples, segment 413 bp to 126 kb, 2 inversion
// rows at a cut site, 0 translocations, 0 off-target junctions). See docs/OFFTARGET.md.
//
// These were labelled "multi-cut deletion" until 2026-08-20. The classifier ignored `strands`, and
// every same-chromosome row in this queue is +-/-+ — an inversion. Orientation is now part of the
// call.
//
