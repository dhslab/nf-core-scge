...
# open bam file(s)
expsamfile = pysam.AlignmentFile(args.expbamfile,"rc",reference_filename="/storage2/fs1/dspencer/Active/clinseq/projects/scge/data/refdata/singh/hg38_PLVM_CD19_CARv4_cd34.fa")
